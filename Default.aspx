...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <h3>Search By Image.</h3>
        ...
        <br />
        <asp:Button ID="Up" runat="server" OnClick="SearchByImge" Text="Search " Width="135px" />
        <br />
        <br />
...
&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <asp:Button ID="Button1" runat="server" OnClick="SearchByName" Text="Search" Width="142px" />
